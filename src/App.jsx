...
const MaternityProfileDetail = lazy(() => import('./Maternity/MaternityProfileDetail'));
const AddAdmission = lazy(() => import('./layouts/AddAdmission'));
const MaternityAntenatalProfile = lazy(() => import('./Maternity/MaternityAntenatalProfile'));
...
// const Admission = lazy(() => import('./layouts/Admission'));
const MaternityServices = lazy(() => import('./Maternity/MaternityServices'));
