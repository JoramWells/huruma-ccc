...
export const {
  useGetAllPayrollDeductionsQuery, useAddPayrollDeductionsMutation, useGetPayrollDeductionsQuery,
  useUpdatePayrollDeductionsMutation, useDeletePayrollDeductionsMutation,
